...
class TurnoControllerTest {
  ...
  void setUp() throws Exception {
    ...
    odontologo = new OdontologoDTO("M123", "Tomas", "Costa");
    odontologoInexistente = new OdontologoDTO(999, "NN", "NN", "NN");
    odontologoExistente = new OdontologoDTO(3, "M123", "Tomas", "Costa");
    
    DomicilioDTO domicilio = new DomicilioDTO("SANTA FE", 123, "CHASCOMUS", "BUENOS AIRES");
    paciente = new PacienteDTO("ENRIQUE","COSTA","123", LocalDate.now());
    paciente.setDomicilio(domicilio);
    pacienteInexistente = new PacienteDTO(999, "NN", "NN", "NN", LocalDate.now());
    pacienteExistente = new PacienteDTO(3, "ENRIQUE","COSTA","123", LocalDate.now());
    domicilio.setId(3);
    pacienteExistente.setDomicilio(domicilio);
    pacienteInexistente.setDomicilio(domicilio);
    
    turno = new TurnoDTO(LocalDateTime.of(2023, 9, 18, 14, 30), paciente, odontologo);
    turnoVacio = new TurnoDTO(LocalDateTime.of(2023, 9, 18, 14, 30),null, null);
    turnoExistente = new TurnoDTO(2, LocalDateTime.of(2023, 9, 18, 14, 30), pacienteExistente, odontologoExistente);
    turnoInexistente = new TurnoDTO(999, LocalDateTime.of(2023, 9, 18, 14, 30), pacienteExistente, odontologoExistente);
  }
