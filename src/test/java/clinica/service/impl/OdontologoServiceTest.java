...
class OdontologoServiceTest {
  ...
  public void setUp() {
    ...
    odontologo.setApellido("Costa");
    odontologo.setNumeroMatricula("M010");
  }
  ...
  void actualizar() throws Exception {
    OdontologoDTO odontologoGuardado = odontologoService.guardar(odontologo);
    odontologoGuardado.setNombre("Mia");
    odontologoGuardado.setApellido("Carpinetti");
    odontologoGuardado.setNumeroMatricula("H010");
