...
class TurnoServiceTest {
  ...
  public void setUp() {
    ...
    paciente.setApellido("Costa");
    paciente.setCedula("123456");
    paciente.setDomicilio(domicilio);
    
    odontologo = new OdontologoDTO();
    odontologo.setNombre("Mia");
    odontologo.setApellido("Carpinetti");
    odontologo.setNumeroMatricula("000578923");
  }
  ...
  void buscar() throws Exception {
    ...
    OdontologoDTO odontologoGuardado = odontologoService.guardar(odontologo);
    TurnoDTO turno = new TurnoDTO();
    turno.setFecha(LocalDateTime.of(2023, 9, 18, 14, 30));
    turno.setPaciente(pacienteGuardado);
    turno.setOdontologo(odontologoGuardado);
    TurnoDTO turnoGuardado = turnoService.guardar(turno);
  ...
  void actualizar() throws Exception {
    ...
    TurnoDTO turnoGuardado = turnoService.guardar(turno);
    turnoGuardado.setFecha(LocalDateTime.of(2023, 9, 18, 14, 30));
